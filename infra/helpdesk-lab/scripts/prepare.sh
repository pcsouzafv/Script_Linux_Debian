...
required_vars=(
    ...
    ZABBIX_DB_USER
    ZABBIX_DB_PASSWORD
    GRAFANA_ZABBIX_DB_USER
    GRAFANA_ZABBIX_DB_PASSWORD
    OPS_POSTGRES_DB
    OPS_POSTGRES_USER
...
sed \
    ...
    -e "s|\${GRAFANA_ZABBIX_DB_USER}|$GRAFANA_ZABBIX_DB_USER|g" \
    -e "s|\${GRAFANA_ZABBIX_DB_PASSWORD}|$GRAFANA_ZABBIX_DB_PASSWORD|g" \
